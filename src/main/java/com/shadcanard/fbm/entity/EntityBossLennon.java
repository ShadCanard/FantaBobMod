...
public class EntityBossLennon extends EntityMob implements IRangedAttackMob {
    private static final DataParameter<Integer> FIRST_HEAD_TARGET = EntityDataManager.<Integer>createKey(EntityBossLennon.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> SECOND_HEAD_TARGET = EntityDataManager.<Integer>createKey(EntityBossLennon.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> THIRD_HEAD_TARGET = EntityDataManager.<Integer>createKey(EntityBossLennon.class, DataSerializers.VARINT);
    ...
    private static final DataParameter<Integer> INVULNERABILITY_TIME = EntityDataManager.<Integer>createKey(EntityBossLennon.class, DataSerializers.VARINT);
    ...
    {
        this.tasks.addTask(0, new EntityBossLennon.AIDoNothing());
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else if (source != DamageSource.drown && !(source.getEntity() instanceof EntityBossLennon))
        {
    ...
    class AIDoNothing extends EntityAIBase
    {
        ...
        {
            return EntityBossLennon.this.getInvulTime() > 0;
        }
    }
}