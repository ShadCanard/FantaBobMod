...
public class AchievementHandler {
    ...
    public static Achievement getHairPotionAch = new Achievement("achievement." + Names.Achievements.GET_HAIR_POTION, Names.Achievements.GET_HAIR_POTION, -12, 2, ModArmor.hairPotion, AchievementList.openInventory).registerStat();
    ...
    public static Achievement getCobbleTieAch = new Achievement("achievement." + Names.Achievements.GET_COBBLE_TIE, Names.Achievements.GET_COBBLE_TIE, -8, 2, ModArmor.cobbleTie, AchievementList.openInventory).registerStat();
    ...
    public static Achievement getFantaGlassesAch = new Achievement("achievement." + Names.Achievements.GET_FANTA_GLASSES, Names.Achievements.GET_FANTA_GLASSES, -6, -2, ModArmor.fantaGlasses, killFantaAch).registerStat();
