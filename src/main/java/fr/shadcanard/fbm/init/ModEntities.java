...
public class ModEntities {
    ...
    public static void init() {
        ...
        EntityRegistry.registerGlobalEntityID(EntityJeanKevin.class, Names.Entities.JEAN_KEVIN, EntityRegistry.findGlobalUniqueEntityId(), new Color(50, 210, 150).getRGB(), new Color(50, 50, 255).getRGB());
        EntityRegistry.registerModEntity(EntityJeanKevin.class, Names.Entities.JEAN_KEVIN, EntityRegistry.findGlobalUniqueEntityId(), FantaBobMod.instance,40,1,true);

        EntityRegistry.registerGlobalEntityID(EntityBot.class, Names.Entities.BOT, EntityRegistry.findGlobalUniqueEntityId(), new Color(255, 182, 90).getRGB(), new Color(180, 0, 0).getRGB());
        EntityRegistry.registerModEntity(EntityBot.class, Names.Entities.BOT, EntityRegistry.findGlobalUniqueEntityId(), FantaBobMod.instance,40,1,true);
